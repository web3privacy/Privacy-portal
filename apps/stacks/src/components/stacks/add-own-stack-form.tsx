  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 items-center gap-1 whitespace-nowrap rounded-[100px] bg-[#70ff88] px-4 text-left text-[13px] font-semibold leading-none tracking-[0.05em] text-black transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#5bee72] hover:shadow-[0_12px_24px_rgba(89,242,109,0.35)]"
      >
